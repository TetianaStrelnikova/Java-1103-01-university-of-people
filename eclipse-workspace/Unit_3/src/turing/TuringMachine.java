	...
	public String run(Tape tape) throws IllegalStateException {
		...
		while (currentState >= 0) {
			...
			Rule applicableRule = null;
				...
				// Print the current state, tape content, and applicable rule
		        System.out.println("Current state: " + currentState);
		        System.out.println("Tape content: " + tape.getTapeContents());
		        System.out.println("Applicable rule: " + (applicableRule != null ? applicableRule.toString() : "null"));
				
			
				
				
			if (applicableRule == null)
				throw new IllegalStateException("Cannot find an applicable rule; tape contents = " + tape.getTapeContents());
